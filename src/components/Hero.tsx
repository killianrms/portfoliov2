      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 md:px-12 flex flex-col h-full">
        ...
        <div className="pb-12 md:pb-16 flex flex-col md:flex-row items-start md:items-end justify-between gap-8">
          ...
          >
            ...
            <a href="https://instagram.com/killianrms" target="_blank" rel="noopener noreferrer" className="text-muted hover:text-foreground transition-colors duration-300" aria-label="Instagram">
            ...
            <a href="https://x.com/killianrms" target="_blank" rel="noopener noreferrer" className="text-muted hover:text-foreground transition-colors duration-300" aria-label="X/Twitter">
