...
/**
 * Hero uses pure CSS animations instead of framer-motion.
 * This removes ~40KB of JS from the critical rendering path,
 * allowing the LCP element (h1) to paint without waiting for JS execution.
 */
  ...
  return (
    <section className="relative h-screen w-full flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 md:px-12 flex flex-col h-full">
        {/* Top section - Name */}
        <div className="pt-24 md:pt-32 hero-fade-in hero-delay-1">
        ...
        <div className="pb-16 md:pb-16 flex flex-col md:flex-row items-start md:items-end justify-between gap-8">
          {/* Tagline */}
          <div className="max-w-lg hero-fade-in hero-delay-2">
          ...
          {/* Social Links */}
          <div className="flex items-center gap-5 hero-fade-in hero-delay-3">
