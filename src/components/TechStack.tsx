...
const technologies: Tech[] = [
  ...
  { name: "Spring Boot", category: "Frameworks", color: "text-green-400 border-green-500/30 bg-green-500/5" },
  { name: "Node.js", category: "Frameworks", color: "text-green-500 border-green-600/30 bg-green-600/5" },
  { name: "Express", category: "Frameworks", color: "text-slate-400 border-slate-500/30 bg-slate-500/5" },
  ...
  { name: "Jenkins", category: "DevOps", color: "text-red-300 border-red-400/30 bg-red-400/5" },
